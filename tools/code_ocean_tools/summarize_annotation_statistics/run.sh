...
# Run SPAC template
python -c "from spac.templates.summarize_annotation_statistics_template import run_from_json; run_from_json('/results/jsons/cleaned_params.json', output_dir='/results')"
