...
echo "Labels_of_Interest: $Labels_of_Interest"
...
# Run SPAC template
python -c "from spac.templates.select_values_template import run_from_json; run_from_json('/results/jsons/cleaned_params.json', output_dir='/results')"
