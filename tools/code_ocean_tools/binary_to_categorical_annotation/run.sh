...
# Run SPAC template
python -c "from spac.templates.binary_to_categorical_annotation_template import run_from_json; run_from_json('/results/jsons/cleaned_params.json', output_dir='/results')"
