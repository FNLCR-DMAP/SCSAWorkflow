...
echo "X_Centroid_Name: $X_Centroid_Name"
echo "Y_Centroid_Name: $Y_Centroid_Name"
...
# Run SPAC template
python -c "from spac.templates.calculate_centroid_template import run_from_json; run_from_json('/results/jsons/cleaned_params.json', output_dir='/results')"
