...
CSV_Files_Configuration_Pattern="*config*.csv"
String_Columns="[]"
...
echo "CSV_Files_Configuration_Pattern: $CSV_Files_Configuration_Pattern"
...
CSV_FILES=$(find -L ../data -type f -name "$CSV_Files_Pattern" ! -name "$CSV_Files_Configuration_Pattern" 2>/dev/null | sort)
...
echo "Searching for config file matching pattern: $CSV_Files_Configuration_Pattern"
CONFIG_INPUT=$(find -L ../data -type f -name "$CSV_Files_Configuration_Pattern" 2>/dev/null | head -n 1)
if [ -z "$CONFIG_INPUT" ]; then echo "ERROR: No configuration file found in ../data matching pattern: $CSV_Files_Configuration_Pattern"; exit 1; fi
