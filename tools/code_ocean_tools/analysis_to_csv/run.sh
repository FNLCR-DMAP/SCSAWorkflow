...
echo "Table_to_Export: $Table_to_Export"
echo "Save_as_CSV_File: $Save_as_CSV_File"
...
# Run SPAC template
python -c "from spac.templates.analysis_to_csv_template import run_from_json; run_from_json('/results/jsons/cleaned_params.json', output_dir='/results')"
