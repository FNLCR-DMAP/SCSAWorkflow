...
print(adata)
# ------------------------------------------------------------------
# 2. Pin‑color map (optional but looks nicer)
# ------------------------------------------------------------------
palette = {"Cluster A": "#1f77b4", "Cluster B": "#ff7f0e", "Cluster C": "#2ca02c"}
adata.uns["pin_colors"] = palette
