...
def dendrogram(
    ...
    # Print the value of var_names and groupby
    print("FL - Value of var_names:", var_names)
    print("FL - Value of groupby:", groupby)
    if var_names is None:
        rep_df = pd.DataFrame(
            _choose_representation(adata, use_rep=use_rep, n_pcs=n_pcs)
        )
        # Print the value returned by _choose_representation
        print("FL")
        print("Initial rep_df after _choose_representation:\n", rep_df.head())
        ...
        # Print the resulting value of categorical
        print("FL")
        print("Value of categorical:\n", categorical.head())
        ...
        # Print the values of gene_names, adata.raw.var_names, and adata.var_names
        print("FL - Value of gene_names:", gene_names)
        if use_raw:
            print("FL - Value of adata.raw.var_names:", adata.raw.var_names)
        else:
            print("FL - Value of adata.var_names:", adata.var_names)

        from ..plotting._anndata import _prepare_dataframe

        categories, rep_df = _prepare_dataframe(adata, gene_names, groupby, use_raw)
    print("===== rep_df Inspection =====")
    ...
    print("===== mean_df Inspection =====")
    print("mean_df shape:", mean_df.shape)
    print("mean_df values:\n", mean_df.head())
    print("mean_df index:\n", mean_df.index)
